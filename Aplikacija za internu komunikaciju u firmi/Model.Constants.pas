...
const
  ...
  sActivityCalls = 'Calls';
  sActivityPrivacy = 'PrivacyPolicy';
  sActivityTermsOfUse = 'TermsOfUse';
  sActivityData = 'Data';
  sActivityAccount = 'Account';
  sActivityChat = 'Chat';
  sActivityInbox = 'Inbox';
  sActivityTasks = 'Tasks';
  sActivityTeams = 'Teams';
  sActivityAddTask = 'AddTask';
  ...
  arrActivitiesList: array [0 .. dActivitiesCount - 1] of string =
    (sActivityChat, sActivityCalls, sActivityTasks, sActivityAddTask,
    sActivitySignInName, sActivitySignUp, sActivityHomeName, sActivitySettings, sActivityAccount);
