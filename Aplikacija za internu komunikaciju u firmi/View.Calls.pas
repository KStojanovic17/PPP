...
uses
  ...
  FMX.ListView.Adapters.Base, FMX.ListView, Threading, Data.DB, DBAccess,
  MyAccess, MemDS, System.Rtti, System.Bindings.Outputs, Fmx.Bind.Editors,
  Data.Bind.EngExt, Fmx.Bind.DBEngExt, Data.Bind.Components, Data.Bind.DBScope;

type
  // Contacts list (Address book) form.
  TCallsFrame = class(TMainFrame)
...
procedure TCallsFrame.Button1Click(Sender: TObject);
begin
 MyTable1.Append;

end;

constructor TCallsFrame.Create(Owner: TComponent);
begin
  inherited;
{$IFDEF MSWINDOWS}
...
destructor TCallsFrame.Destroy;
begin
  inherited;
end;
...
initialization
  // Register frame
  RegisterClass(TCallsFrame);
finalization
  // Unregister frame
  UnRegisterClass(TCallsFrame);
